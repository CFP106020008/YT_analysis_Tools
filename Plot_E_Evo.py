...
plt.semilogy(OUT[0,1:,0], OUT[1,1:,1], linestyle='solid' , color='r', label=r"Proton Jet $E_k$")
plt.semilogy(OUT[0,1:,0], OUT[2,1:,1], linestyle='solid' , color='b', label=r"Electron Jet $E_k$")
plt.legend()
#plt.tight_layout()
