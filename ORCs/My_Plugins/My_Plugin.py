...
def Zlim(Field):
    ZLIMS = {'Heating/Cooling':[1e-1, 1e1],
             'CR_energy_density':[1.e-10, 2.e-9],
...
def Load_Simulation_Datas():
    ...
    CRpS_ORCs = yt.load("/data/yhlin/CRpS_ORC/crbub_hdf5_plt_cnt_*") # Convergence test on Emax and Emin
    CRpS_ORCHR = yt.load("/data/yhlin/CRpS_ORCHR/crbub_hdf5_plt_cnt_*") # Convergence test on Emax and Emin
    CRpS_ORCLM = yt.load("/data/yhlin/CRpS_ORCLM/crbub_hdf5_plt_cnt_*") # Convergence test on Emax and Emin
    CRpS_ORCLMLT = yt.load("/data/yhlin/CRpS_ORC_LM_LT/crbub_hdf5_plt_cnt_*") # Convergence test on Emax and Emin
    CRpS_ORCLMLTLP = yt.load("/data/yhlin/CRpS_ORC_LM_LT_LP/crbub_hdf5_plt_cnt_*") # Convergence test on Emax and Emin
    CRpS_ORCLMLTLP100 = yt.load("/data/yhlin/CRpS_ORC_LM_LT_LP_100/crbub_hdf5_plt_cnt_*") # Convergence test on Emax and Emin
    CRpS_ORCHM = yt.load("/data/yhlin/ORCs/CRpS_HalfMass/crbub_hdf5_plt_cnt_*") # Convergence test on Emax and Emin
    CRpS_ORCHMDP = yt.load("/data/yhlin/ORCs/CRpS_HalfMass_DoublePower/crbub_hdf5_plt_cnt_*") # Convergence test on Emax and Emin
    CRpS_ORCHMLJ = yt.load("/data/yhlin/ORCs/CRpS_HalfMass_LongJet/crbub_hdf5_plt_cnt_*") # Convergence test on Emax and Emin
    CRpS_ORCHMNJ = yt.load("/data/yhlin/ORCs/CRpS_HalfMass_NoJet/crbub_hdf5_plt_cnt_*") # Convergence test on Emax and Emin
    CRpS_ORCHMNJNC = yt.load("/data/yhlin/ORCs/CRpS_HalfMass_NoJet_NoRadCool/crbub_hdf5_plt_cnt_*") # Convergence test on Emax and Emin
    Datas = {'CRp'          : CRp,
             'CRe'          : CRe,
             'CRpS'         : CRpS,
             'CReS'         : CReS,
             ...
             'CRpS_ORC': CRpS_ORCs,
             'CRpS_ORCHR': CRpS_ORCHR,
             'CRpS_ORCLM': CRpS_ORCLM,
             'CRpS_ORCLMLT': CRpS_ORCLMLT,
             'CRpS_ORCLMLTLP': CRpS_ORCLMLTLP,
             'CRpS_ORCLMLTLP100': CRpS_ORCLMLTLP100,
             'CRpS_ORCHM': CRpS_ORCHM,
             'CRpS_ORCHMDP': CRpS_ORCHMDP,
             'CRpS_ORCHMLJ': CRpS_ORCHMLJ,
             'CRpS_ORCHMNJ': CRpS_ORCHMNJ,
             'CRpS_ORCHMNJNC': CRpS_ORCHMNJNC
            }
    return Datas
